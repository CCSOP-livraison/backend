...
7. [Validation & Tests pour le End-User](#validation--tests-pour-le-end-user)
8. [Problèmes Connus & Limitations](#problèmes-connus--limitations)

---

## Descriptif du Projet

**CCSOP livraison** est une plateforme web pour commander des repas auprès des restaurants partenaires avec livraison. **anonyme**.
...
📎 **Schéma d'infrastructure réseau** : [voir le diagramme]()
...
L'ensemble des diagrammes du projet - **modèle conceptuel des données (MCD)**, **diagrammes de classes** des microservices et diagrammes de séquences - sont disponibles dans le dossier [`.docs/img`](.docs/img).
